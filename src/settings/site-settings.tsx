...
export const siteSettings = {
  name: 'CellsFlux',
  description: 'Acheter des produts dans les shop les plus prochent de chez vous, vendez en securite et decouvrez la performence marketing digitage .',
  author: {
    name: 'CellsFlux Inc.',
    websiteUrl: 'https://CellsFlux.com',
    address: 'carefour Lubumbashi, DRC, Rondpoint acient batiment GCAMIN',
  },
  logo: {
    url: '/assets/images/logocellsflux.png',
    alt: 'CellsFlux',
    href: '/',
    width: 95,
    height: 30,
